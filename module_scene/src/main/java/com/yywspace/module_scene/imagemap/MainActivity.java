package com.yywspace.module_scene.imagemap;
...
import com.yywspace.module_scene.imagemap.support.CircleShape;
import com.yywspace.module_scene.imagemap.support.PolyShape;
import com.yywspace.module_scene.imagemap.support.RectShape;
import com.yywspace.module_scene.imagemap.support.Shape;
import com.yywspace.module_scene.imagemap.support.ShapeExtension;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.drawable.ic_floor_four,new BitmapFactory.Options());
        map.setMapBitmap(bitmap);

        // set shape click listener
        map.setOnShapeClickListener((shape, xOnImage, yOnImage) -> {
