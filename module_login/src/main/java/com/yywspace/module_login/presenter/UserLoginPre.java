...
public class UserLoginPre extends LoginPresenter.UserLoginPresenter {
    ...
    public void login(LifecycleOwner owner) {
        ...
        ServerUtils.getCommonApi().login(body).observe(owner, userBaseResponse -> {
            ...
            else if (userBaseResponse.getCode() == 2001) // 用户不存在
